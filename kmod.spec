...
Source0  : https://www.kernel.org/pub/linux/utils/kernel/kmod/kmod-32.tar.gz
...
%prep
%setup -q -n kmod-32
cd %{_builddir}/kmod-32
%patch -P 1 -p1
pushd ..
cp -a kmod-32 build32
popd
pushd ..
cp -a kmod-32 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718727279
unset LD_AS_NEEDED
