...
Source0  : https://www.kernel.org/pub/linux/utils/kernel/kmod/kmod-29.tar.xz
...
%prep
%setup -q -n kmod-29
cd %{_builddir}/kmod-29
pushd ..
cp -a kmod-29 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621617948
unset LD_AS_NEEDED
...
cp %{_builddir}/kmod-29/COPYING %{buildroot}/usr/share/package-licenses/kmod/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/kmod-29/libkmod/COPYING %{buildroot}/usr/share/package-licenses/kmod/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/kmod-29/testsuite/COPYING %{buildroot}/usr/share/package-licenses/kmod/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/kmod-29/tools/COPYING %{buildroot}/usr/share/package-licenses/kmod/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd ../build32/
%make_install32
