...
%prep
%setup -q -n kmod-30
cd %{_builddir}/kmod-30
pushd ..
cp -a kmod-30 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656620028
unset LD_AS_NEEDED
...
cp %{_builddir}/kmod-30/COPYING %{buildroot}/usr/share/package-licenses/kmod/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/kmod-30/libkmod/COPYING %{buildroot}/usr/share/package-licenses/kmod/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/kmod-30/testsuite/COPYING %{buildroot}/usr/share/package-licenses/kmod/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/kmod-30/tools/COPYING %{buildroot}/usr/share/package-licenses/kmod/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd ../build32/
%make_install32
