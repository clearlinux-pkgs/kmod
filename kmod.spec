...
cp %{_builddir}/kmod-27/libkmod/COPYING %{buildroot}/usr/share/package-licenses/kmod/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/kmod-27/testsuite/COPYING %{buildroot}/usr/share/package-licenses/kmod/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/kmod-27/tools/COPYING %{buildroot}/usr/share/package-licenses/kmod/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd ../build32/
%make_install32
...
/usr/lib64/libkmod.so.2.3.5

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libkmod.so.2
/usr/lib32/libkmod.so.2.3.5
