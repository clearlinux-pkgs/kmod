...
Source0  : https://www.kernel.org/pub/linux/utils/kernel/kmod/kmod-33.tar.gz
...
%prep
%setup -q -n kmod-33
cd %{_builddir}/kmod-33
pushd ..
cp -a kmod-33 build32
popd
pushd ..
cp -a kmod-33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723658513
unset LD_AS_NEEDED
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkmod.so.2.5.0
/usr/lib64/libkmod.so.2
/usr/lib64/libkmod.so.2.5.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libkmod.so.2
/usr/lib32/libkmod.so.2.5.0
